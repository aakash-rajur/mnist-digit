...
def extract_features(config: dict, data_source_factory: dict, parallel: bool, show_progress: bool):
    ...
    for character, data_sources in character_configs.items():
        ...
        features[character] = compile_data_sources(data_sources, parallel, show_progress)
